...
_ Независимо от того, решите ли вы проводить традиционную терапию или нет, рекомендуется использовать этот протокол в качестве основы. Те люди, которые также проходят химиотерапию/лучевую терапию, тоже могут получить от этого пользу._
...
1. **Львиная доля пищи должна составлять овощи, особенно крестоцветные**.
  - Без ограничений, но не менее 10 чашек в день.
  - Избегайте кукурузы и сои.
